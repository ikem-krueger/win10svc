...
import show_about_dialog_support
...
def vp_start_gui():
    ...
    show_about_dialog_support.init(root, top)
    root.mainloop()
...
def create_New_Toplevel_1(root, *args, **kwargs):
    ...
    show_about_dialog_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class New_Toplevel_1:
    def __init__(self, top=None):
        ...
        self.TLabel1.place(relx=0.31, rely=0.1, height=26, width=120)
        self.TLabel1.configure(font="-size 14 -weight bold")
        self.TLabel1.configure(text='''win10srv 1.0''')

        self.TLabel2 = ttk.Label(top)
        self.TLabel2.place(relx=0.17, rely=0.26, height=19, width=196)
        self.TLabel2.configure(text='''A small tool to reset the Windows 10''')

        self.TLabel5 = ttk.Label(top)
        self.TLabel5.place(relx=0.17, rely=0.36, height=19, width=190)
        self.TLabel5.configure(text='''services back to their default states.''')

        self.TLabel3 = ttk.Label(top)
        self.TLabel3.place(relx=0.2, rely=0.52, height=19, width=176)
        self.TLabel3.configure(text='''Copyright (C) 2017 Ikem Krueger''')

        self.TLabel4 = ttk.Label(top)
        self.TLabel4.place(relx=0.1, rely=0.67, height=19, width=229)
